...
\usepackage{graphicx}
\usepackage{geometry}
\usepackage{babel} % Per la lingua italiana, sillabazione corretta
\usepackage{hyperref} % Per i link interni ed esterni
\usepackage{listings} % Per eventuale codice
\usepackage{array} % Per tabelle più flessibili
...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={Guida Passo Passo a Calcolo delle Probabilità e Statistica},
